var nbDrop = 800;
   ...
   const project=[
       ...
       {name: "2j water (not yet Available)", image:"images/water-drop.png", link:"#!"},
       {name: "Priscy's Liquorshop (not yet Available)", image:"images/liquor.png", link:"#!"},
       {name: "first-rate care (not yet Available)", image:"images/first-rate.png", link:"#!"},
       {name: "Aulda (not yet Available)", image:"images/aulda.png", link:"#!"}
   ]
